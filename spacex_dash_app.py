...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # For all sites - show total success launches count for all sites
        ...
        # For a specific site - filter the dataframe for this site
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        # Create success/failure count
        site_df = filtered_df['class'].value_counts().reset_index()
        site_df.columns = ['class', 'count']
        # Create pie chart for Success vs Failure for this site
        fig = px.pie(site_df, 
                     values='count', 
                     names='class', 
...
def update_scatter(selected_site, payload_range):
    ...
    # Filter based on site selection
